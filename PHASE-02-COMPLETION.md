...
```env
DATABASE_URL=postgresql://user:password@host:5432/luxbot_db
...
- **Main Plan:** `/var/www/LuxBot/plans/251216-0515-executive-assistant-chatbot/plan.md`
- **Phase Document:** `/var/www/LuxBot/plans/251216-0515-executive-assistant-chatbot/phase-02-database-schema.md`
- **Completion Report:** `/var/www/LuxBot/plans/reports/project-manager-phase-02-completion-summary.md`
- **Project Roadmap:** `/var/www/LuxBot/docs/project-roadmap.md`
- **Status Report:** `/var/www/LuxBot/plans/reports/project-status-2025-12-16.md`
