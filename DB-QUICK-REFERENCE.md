...
### Group Management
```typescript
import { upsertGroup, getGroupStats } from '@jarvis/db';
...
### User Management
```typescript
import { upsertUser } from '@jarvis/db';
...
### Message Operations
```typescript
import { saveMessage, getRecentMessages } from '@jarvis/db';
...
```typescript
import { saveExtractedInfo, getExtractedInfoByGroup } from '@jarvis/db';
...
### Memory Operations
```typescript
import { saveMemory, getRecentMemories } from '@jarvis/db';
...
### Vector Search
```typescript
import { searchByVector, searchMemories } from '@jarvis/db';
